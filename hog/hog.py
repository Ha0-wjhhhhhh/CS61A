...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def echo(score_0, score_1):
        if not who:
            if score_0 - last_score > running_high:
                print("{} point(s)! That's a record gain for Player {}!".format(score_0 - last_score, who))
                return announce_highest(who,score_0,score_0 - last_score)
            else:
                return announce_highest(who,score_0, running_high) 
        else:
            if score_1 - last_score > running_high:
                print("{} point(s)! That's a record gain for Player {}!".format(score_1 - last_score, who))
